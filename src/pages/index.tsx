  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Streamlining your employee management tasks, from data handling to vacation planning and payroll administration."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Streamlining your employee management tasks, from data handling to vacation planning and payroll administration.`}
            </Text>
            <Box
