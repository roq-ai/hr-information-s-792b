      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'days_remaining',
              isInvalid: !!formik.errors?.days_remaining,
            }}
            name="days_remaining"
            error={formik.errors?.days_remaining}
            value={formik.values?.days_remaining}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('days_remaining', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
